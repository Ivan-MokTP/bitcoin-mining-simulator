...
public class CameraHandler : MonoBehaviour {
	...
	public static readonly float[] BoundsX = new float[]{-300f, 100f};
	public static readonly float[] BoundsZ = new float[]{-500f, -4f};
	public static readonly float[] ZoomBounds = new float[]{20f, 100f};
